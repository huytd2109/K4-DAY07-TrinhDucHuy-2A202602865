...
|---|-------|--------------------------------|-------|-----------|------------------------|
| 1 | Với giáo trình tại phòng 111, được mượn tối đa bao nhiêu cuốn, trong bao lâu và được gia hạn thế nào? | `student-textbook-borrowing#0`: tiêu đề quy trình; dữ kiện nằm ở top-2 `#9` và top-3 `#10`. | 0,650083 | Có, nhưng dữ kiện không ở top-1 | 8 cuốn; 90 ngày; gia hạn 1 lần thêm 30 ngày, tổng tối đa 120 ngày. |
| 2 | Chính sách mượn sách tham khảo tại phòng 102 quy định số lượng, thời hạn và gia hạn như thế nào? | `student-reference-book-borrowing#7`: chỉ có tiêu đề “Chính sách mượn sách tham khảo”. | 0,646336 | Không đủ dữ kiện | Không thể trả lời đủ từ top-3 vì thiếu các dòng 5 cuốn, 1–30 ngày và gia hạn 7 ngày. |
| 3 | Phòng học nhóm phục vụ vào thời gian nào và quy trình nhận trả chìa khóa ra sao? | `group-study-room#7`: chỉ có tiêu đề “Quy trình đăng ký và sử dụng phòng học nhóm”. | 0,744599 | Không đủ dữ kiện | Không thể trả lời từ top-3 vì không có khung giờ và các bước nhận/trả chìa khóa. |
| 4 | Khi quên mật khẩu tài khoản thư viện, bạn đọc cần thực hiện các bước nào? | `library-account#10`: tiêu đề phần đăng nhập và đổi mật khẩu; top-3 có đoạn gửi email và bước 5. | 0,666802 | Có một phần | Chỉ xác định được hệ thống gửi liên kết qua email và người dùng mở liên kết; thiếu các bước còn lại nên không trả lời trọn vẹn. |
| 5 | Bạn đọc ngoài HUST có thể đọc toàn văn tài nguyên số không và cần điều kiện gì? | `digital-resource-faq#6`: quyền đọc toàn văn và tải học liệu mở; điều kiện nằm ở top-2 `#5`. | 0,671166 | Có, đủ dữ kiện trong top-2 | Có; cần đăng ký thẻ/tài khoản thư viện. Sau khi đăng nhập được đọc toàn văn và tải học liệu mở. |
